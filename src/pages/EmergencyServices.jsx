  ...
  return (
    <main className="min-h-screen bg-black text-zinc-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="mb-6 text-zinc-300">We restore both function and regulatory compliance. Certified technicians respond within 4 hours across Centurion, Johannesburg, Pretoria, and the wider Gauteng region.</p>
        ...
        <p>24/7 Hotline: <a className="text-red-400 hover:text-red-300" href="tel:+27XXXXXXXXX">+27 XX XXX XXXX</a></p>
        <p>Email: <a className="text-red-400 hover:text-red-300" href="mailto:emergency@promptair.co.za">emergency@promptair.co.za</a></p>
